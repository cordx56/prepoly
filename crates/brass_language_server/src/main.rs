//! The Brass language server.
//!
//! A stdio JSON-RPC LSP server that drives the Brass front end (lex, parse,
...
async fn main() {
    // Logs go to stderr -- stdout is the LSP transport. Same BRASS_LOG /
    // BRASS_LOG_TYPE switches as the driver.
