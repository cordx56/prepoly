...
use prepoly_plugin_host::{PluginFunction, PluginManifest, ValueType, fixture};
use prepoly_resolve::plugin::{synthesize_plugin_module, synthesize_source};
...
fn fixture_manifest_synthesizes_wrappers() {
    ...
    // A Prepoly keyword and a runtime builtin are legal Rust function names.
...
/// The library path is embedded in a Prepoly string literal, where `{` opens
